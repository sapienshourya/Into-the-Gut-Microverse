...
df = pd.read_csv("/home/group16/MLBIO/Shourya doing work/significant_features_FRANZOSA.csv")
...
reduced_df.to_csv("further_reduced_features_FRANZOSA.csv", index=False)
